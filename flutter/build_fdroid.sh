...
#
# Script to build F-Droid release of VNFap
#
# Copyright (C) 2024, The VNFap Authors
...
prebuild)
	...
	# Flutter used to compile main VNFap library
	...
	# Install Flutter version for VNFap library build
...
build)
	...
	cp "target/${RUST_TARGET}/release/liblibvnfap.so" \
		"flutter/android/app/src/main/jniLibs/${ANDROID_ABI}/libvnfap.so"
