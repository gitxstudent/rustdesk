...
class FfiModel with ChangeNotifier {
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsVNFapVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsVNFapVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsVNFapVirtualDisplays);
        }
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get VNFapVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsVNFapVirtualDisplays] ?? []);
  ...
  bool get isVNFapIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'vnfap_idd';
