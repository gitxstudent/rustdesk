...
class _DesktopTabState extends State<DesktopTab>
  ...
  void onWindowClose() async {
    ...
    if (isMainWindow) {
      if (vnfapWinManager.getActiveWindows().contains(kMainWindowId)) {
        await vnfapWinManager.unregisterActiveWindow(kMainWindowId);
      }
