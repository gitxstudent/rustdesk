...
pub const PORTABLE_APPNAME_RUNTIME_ENV_KEY: &str = "VNFAP_APPNAME";
...
pub async fn do_check_software_update() -> hbb_common::ResultType<()> {
    let (request, url) =
        hbb_common::version_check_request(hbb_common::VER_TYPE_VNFAP_CLIENT.to_string());
...
#[inline]
pub fn is_vnfap() -> bool {
    hbb_common::config::APP_NAME.read().unwrap().eq("VNFap")
}
...
fn get_api_server_(api: String, custom: String) -> String {
    ...
    "https://admin.vnfap.com".to_owned()
}

#[inline]
pub fn is_public(url: &str) -> bool {
    url.contains("vnfap.com")
}
...
pub fn check_process(arg: &str, mut same_uid: bool) -> bool {
    ...
    for (_, p) in sys.processes().iter() {
        ...
        // on mac, p.cmd() get "/Applications/VNFap.app/Contents/MacOS/VNFap", "XPC_SERVICE_NAME=com.carriez.VNFap_server"
...
pub type VNFapInterval = ThrottledInterval;

#[inline]
pub fn vnfap_interval(i: Interval) -> ThrottledInterval {
...
mod tests {
    ...
    async fn test_VNFap_interval() {
        ...
        for maker in base_intervals.into_iter() {
            ...
            let mut timer = vnfap_interval(maker());
    ...
    #[allow(non_snake_case)]
    #[tokio::test]
    async fn test_VNFap_interval_sleep() {
        let base_intervals = [interval_maker, interval_at_maker];
