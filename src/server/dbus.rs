...
///
/// Note:
/// On linux, we use dbus to communicate multiple vnfap process.
...
const DBUS_NAME: &str = "org.vnfap.vnfap";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "VNFap DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.vnfap.vnfap /dbus org.vnfap.vnfap.NewConnection string:'PEER_ID'`
