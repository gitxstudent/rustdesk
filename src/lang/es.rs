...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red VNFap en progreso..."),
        ...
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a VNFap de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a VNFap de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que VNFap use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [VNFap Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep VNFap background service", "Dejar VNFap como Servicio en 2do plano"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a VNFap permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a VNFap permisos de \"Grabar Audio\"."),
        ...
        ("verify_vnfap_password_tip", "Verificar la contraseña de VNFap"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses VNFap e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_vnfap_server_pro_to_{}_tip", "¡Por favor, actualiza VNFap Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que VNFap no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de VNFap"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de VNFap de fondo"),
        ...
        ("upgrade_remote_vnfap_client_to_{}_tip", "Por favor, actualiza el cliente VNFap a la versión {} o superior en el lado remoto"),
