...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "VNFapi võrguga ühendumine..."),
        ...
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb VNFapile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb VNFapile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma VNFapile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [VNFap Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep VNFap background service", "Säilita VNFapi taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele VNFapi rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma VNFapile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma VNFapile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud VNFapi kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_vnfap_password_tip", "Kinnita VNFapi parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul VNFapi kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_vnfap_server_pro_to_{}_tip", "Palun täienda VNFap Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib VNFapil takistada juhitud poolel toimimist."),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui VNFapi aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada VNFapi taustateenust."),
        ...
        ("upgrade_remote_vnfap_client_to_{}_tip", "Täiendage VNFapi klient kaugküljel versioonile {} või uuemale!"),
