...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione a sa rete VNFap..."),
        ...
        ("Configure", "Cunfigura"),
        ("config_acc", "Pro controllare s'iscrivania dae foras, depes frunire a VNFap su permissu 'Atzessibilidade'."),
        ("config_screen", "Pro controllare s'iscrivania dae foras, depes frunire a VNFap su permissu 'Registratzione ischermu'."),
        ...
        ("android_input_permission_tip1", "Pro chi unu dispositivu remotu potzat controllare unu dispositivu Android pro mèdiu de unu ratu o cun su tocu, depes cunsentire a VNFap de impreare su servìtziu 'Atzessibilidade'."),
        ("android_input_permission_tip2", "Bae a sa pàgina de sas impostatziones de sistema chi s'at a abèrrere a pustis, busca e intra a [Servìtzios installados], allughe su servìtziu [Intrada VNFap]."),
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep VNFap background service", "Mantene su servìtziu de VNFap in s'isfundu"),
        ("Ignore Battery Optimizations", "Ignora sas otimizatziones de sa bateria"),
        ("android_open_battery_optimizations_tip", "Si boles disabilitare custa funtzione, bae a sas impostatziones de s'aplicatzione VNFap, aberi sa setzione 'Bateria' e boga sa seletzione a 'Chene restritziones'."),
        ...
        ("config_input", "Pro controllare s'elaboradore remotu cun su tecladu bisòngiat a frunire a VNFap sos permissos de 'Monitoràgiu insertada'."),
        ("config_microphone", "Per pòdere mutire, bisòngiat a frunire su premissu 'Registra àudio' a VNFap."),
        ...
        ("still_click_uac_tip", "Torra a pedire chi s'utente remotu seletziones 'AB' in sa ventana UAC de s'esecutzione de VNFap."),
        ...
        ("verify_vnfap_password_tip", "Cunfirma sa crae de VNFap"),
        ...
        ("scam_text1", "Si ses in su telèfonu cun calicunu chi NON connosches NON FIDADU chi t'at pedidu de impreare VNFap e de allùghere su servìtziu, non sigas e tanca deretu."),
        ...
        ("upgrade_vnfap_server_pro_to_{}_tip", "Atualiza VNFap Server Pro a sa versione {} o prus noa!"),
        ...
        ("selinux_tip", "In custu dispositivu est abilitadu SELinux, chi diat pòdere su funtzionamentu curretu de VNFap comente ala controllada."),
        ...
        ("powered_by_me", "Alimentadu dae VNFap"),
        ...
        ("allow-only-conn-window-open-tip", "Permite sa connessione petzi si sa ventana VNFap est aberta"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de VNFap"),
        ...
        ("About VNFap", "Informatziones subra de VNFap"),
        ...
        ("upgrade_remote_vnfap_client_to_{}_tip", "Atualiza su cliente VNFap remotu a sa versione {} o prus noa!"),
