...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the VNFap network..."),
        ...
        ("install_tip", "Due to UAC, VNFap can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install VNFap to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant VNFap \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant VNFap \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow VNFap to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [VNFap Input] service."),
        ...
        ("doc_mac_permission", "https://vnfap.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next VNFap application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant VNFap \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant VNFap \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running VNFap."),
        ...
        ("verify_vnfap_password_tip", "Verify VNFap password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use VNFap and start the service, do not proceed and hang up immediately."),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent VNFap from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by VNFap"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if VNFap window is open"),
        ...
        ("floating_window_tip", "It helps to keep VNFap background service"),
        ...
        ("upgrade_remote_vnfap_client_to_{}_tip", "Please upgrade the VNFap client to version {} or newer on the remote side!"),
