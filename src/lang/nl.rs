...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het VNFap netwerk..."),
        ...
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u VNFap toestemming voor Toegankelijkheid geven."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u VNFap toestemming voor Schermopname geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u VNFap toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [VNFap Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep VNFap background service", "VNFap achtergronddienst behouden"),
        ...
        ("config_input", "Om een extern apparaat met uw toetsenbord te kunnen bedienen, moet u VNFap toestemming voor Invoer Vastleggen geven."),
        ("config_microphone", "Om te kunnen chatten moet u VNFap toestemming voor Microfoon geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende VNFap."),
        ...
        ("verify_vnfap_password_tip", "Bevestiging wachtwoord VNFap"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om VNFap te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("upgrade_vnfap_server_pro_to_{}_tip", "Upgrade VNFap Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor VNFap mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het VNFap-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt VNFap op de achtergrond actief te houden"),
        ...
        ("upgrade_remote_vnfap_client_to_{}_tip", "Upgrade de VNFap client naar versie {} of nieuwer op de externe computer!"),
