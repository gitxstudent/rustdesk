...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na VNFap mrežu..."),
        ...
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, VNFap-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, VNFap-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti VNFap-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [VNFap Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep VNFap background service", "Zadrži VNFap kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje VNFap aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti VNFapu dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti VNFapu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog VNFapa."),
        ...
        ("verify_vnfap_password_tip", "Provjera lozinke za VNFap"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete VNFap, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_vnfap_server_pro_to_{}_tip", "Ažurirajte VNFap Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti VNFap da pravilno radi kao upravljana strana."),
        ...
        ("upgrade_remote_vnfap_client_to_{}_tip", "Molimo ažurirajte VNFap klijent na verziju {} ili noviju na udaljenoj strani!"),
