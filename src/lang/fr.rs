...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établie"),
        ("connecting_status", "Connexion au réseau VNFap…"),
        ...
        ("android_input_permission_tip1", "Pour qu’un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher d’écran, vous devez autoriser VNFap à utiliser le service « Accessibilité »."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, puis recherchez et accédez à la section [Services installés] ; activez ensuite le service [VNFap Input]."),
        ...
        ("Language", "Langue"),
        ("Keep VNFap background service", "Garder le service VNFap en arrière plan"),
        ("Ignore Battery Optimizations", "Ignorer les optimisations de la batterie"),
        ("android_open_battery_optimizations_tip", "Pour désactiver cette fonctionnalité, veuillez accéder à la page suivante des paramètres de l’application VNFap, puis recherchez et accédez à la section [Batterie] ; décochez ensuite l’option [Sans restriction]."),
        ...
        ("config_input", "Vous devez accorder à VNFap l’autorisation « Surveillance de l’entrée » pour contrôler le bureau distant avec le clavier."),
        ("config_microphone", "Vous devez accorder à VNFap l’autorisation « Enregistrer l’audio » pour discuter à distance."),
        ...
        ("still_click_uac_tip", "L’utilisateur distant devra malgré tout confirmer l’UAC de l’instance VNFap en cours d’éxécution."),
        ...
        ("verify_vnfap_password_tip", "Vérifier le mot de passe VNFap"),
        ...
        ("scam_text1", "Si vous êtes au téléphone avec quelqu’un QUE VOUS NE CONNAISSEZ PAS et en qui VOUS N’AVEZ PAS CONFIANCE et qui vous a demandé d’utiliser VNFap et de démarrer le service, ne le faites pas et raccrochez immédiatement."),
        ...
        ("upgrade_vnfap_server_pro_to_{}_tip", "Veuillez mettre à jour VNFap Server Pro vers la version {} ou une version ultérieure !"),
        ...
        ("selinux_tip", "SELinux est activé sur votre appareil, ce qui peut empêcher VNFap de fonctionner correctement sur la machine contrôlée."),
        ...
        ("powered_by_me", "Utilise la technologie VNFap"),
        ...
        ("allow-only-conn-window-open-tip", "N’autoriser la connexion que si la fenêtre VNFap est ouverte"),
        ...
        ("upgrade_remote_vnfap_client_to_{}_tip", "Veuillez mettre le client VNFap distant à jour vers la version {} ou ultérieure !"),
