...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete VNFap..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), VNFap potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare VNFap a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Click to download", "Download"),
        ("Click to update", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a VNFap il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a VNFap il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a VNFap di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [VNFap Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep VNFap background service", "Mantieni il servizio di VNFap in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione VNFap, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a VNFap 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a VNFap."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di VNFap."),
        ...
        ("verify_vnfap_password_tip", "Conferma password VNFap"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare VNFap e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_vnfap_server_pro_to_{}_tip", "Aggiorna VNFap Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di VNFap come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da VNFap"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra VNFap è aperta"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio VNFap in background."),
        ...
        ("upgrade_remote_vnfap_client_to_{}_tip", "Aggiorna il client VNFap remoto alla versione {} o successiva!"),
