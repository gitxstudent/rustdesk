...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem VNFap..."),
        ...
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate VNFapu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate VNFapu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno VNFapu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »VNFap Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep VNFap background service", "Ohrani VNFapovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije VNFap, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "VNFap potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "VNFap potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_vnfap_password_tip", "Preveri geslo za VNFap"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite VNFap, prekinite klic in program zaprite."),
        ("scam_text2", "VNFap omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_vnfap_server_pro_to_{}_tip", "Prosimo, nadgradite VNFap Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo VNFap"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno VNFapa odprto"),
        ...
        ("floating_window_tip", "Pomaga pri VNFap storitvi v ozadju"),
        ...
        ("upgrade_remote_vnfap_client_to_{}_tip", "Prosimo, nadgradite VNFap odjemalec na različico {} ali novejšo na oddaljeni strani."),
