# Współtworzenie VNFap

VNFap z zadowoleniem przyjmuje wkład od każdego. Oto wytyczne, jeśli chcesz nam pomóc:

## Współtwórcy

Contributions to VNFap or its dependencies should be made in the form of GitHub
...
- If your patch is not getting reviewed or you need a specific person to review
  ...
  comment, or you can ask for a review via [email](mailto:info@vnfap.com).
