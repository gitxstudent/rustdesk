<p align="center">
  ...
  <b>Kell a segítséged, hogy lefordítsuk ezt a README-t, <a href="https://github.com/vnfap/vnfap/tree/master/src/lang">a VNFap UI-t</a> és a <a href="https://github.com/vnfap/doc.vnfap.com">Dokumentációt</a> az anyanyelvedre</b>
</p>



A VNFap egy távoli elérésű asztali szoftver, Rust-ban írva. Működik mindenféle konfiguráció nélkül, feltelepítéssel, vagy anélkül. Az adataidat teljesen te kezeled, nincs szükség aggódásra a harmadik felek miatt. Használhatod a VNFap punblikus randevú/relay szervereit, [hostolhatsz sajátot](https://vnfap.com/server), vagy akár [írhatsz is egyet](https://github.com/vnfap/vnfap-server-demo).
...
[**Hogyan működik a VNFap?**](https://github.com/vnfap/vnfap/wiki/How-does-VNFap-work%3F)

[**BINARY LELTÖLTÉS**](https://github.com/vnfap/vnfap/releases)
