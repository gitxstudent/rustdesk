...
const APP_PREFIX: &str = "vnfap";
const APPNAME_RUNTIME_ENV_KEY: &str = "VNFAP_APPNAME";
#[cfg(windows)]
...
mod windows {
    ...
    pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_vnfap.exe";
    ...
    pub(super) fn copy_runtime_broker(dir: &Path) {
        ...
        let _allow_err = Command::new("taskkill")
            .args(&["/F", "/IM", "RuntimeBroker_vnfap.exe"])
